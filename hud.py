...
class Hud:
    ...
    def __init__(self, resource_manager, width, height):
        ...
        # resouces hud
        self.resouce_surface = pg.Surface((width, height * 0.02), pg.SRCALPHA)
        self.resource_rect = self.resouce_surface.get_rect(topleft=(0, 0))
        self.resouce_surface.fill(self.hud_colour)
    ...
    def draw(self, screen):
        ...
        # resouce hud
        screen.blit(self.resouce_surface, (0, 0))
        # build hud
